  ...
  return (
    <div
      ...
      className={cn(
        ...
        'bg-muted text-muted-foreground', // default inactive state
        'data-[state=active]:bg-primary-orange data-[state=active]:text-primary-foreground',
        'data-[state=completed]:bg-primary-orange data-[state=completed]:text-primary-foreground',
        className,
      )}
    >
...
function StepperSeparator({ className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'bg-gray-300 group-data-[orientation=vertical]/stepper-nav:h-12 group-data-[orientation=vertical]/stepper-nav:w-0.5 group-data-[orientation=horizontal]/stepper-nav:h-0.5 group-data-[orientation=horizontal]/stepper-nav:w-full data-[state=completed]:bg-primary-orange',
        'h-0.5 w-full', // Full width and visible height
        className,
      )}
    />
  );
...
function StepperNav({ children, className }: React.ComponentProps<'nav'>) {
  ...
  return (
    <nav
      ...
      data-orientation={orientation}
      className={cn(
        'group/stepper-nav w-full  data-[orientation=horizontal]:w-full data-[orientation=horizontal]:flex-row data-[orientation=vertical]:flex-col',
        className,
      )}
    >
      {children}
