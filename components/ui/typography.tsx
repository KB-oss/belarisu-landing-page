...
export function H1({ children, className }: TypographyProps) {
  return (
    <h1 className={cn(
      "scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl font-playfair",
      className
    )}>
      {children}
    </h1>
...
export function H2({ children, className }: TypographyProps) {
  return (
    <h2 className={cn(
      "scroll-m-20 text-3xl font-semibold tracking-tight first:mt-0 font-playfair",
      className
    )}>
      {children}
    </h2>
...
export function H3({ children, className }: TypographyProps) {
  return (
    <h3 className={cn(
      "scroll-m-20 text-2xl font-semibold font-playfair tracking-tight",
      className
    )}>
      {children}
    </h3>
...
export function H4({ children, className }: TypographyProps) {
  return (
    <h4 className={cn(
      "scroll-m-20 text-xl font-semibold tracking-tight font-playfair",
      className
    )}>
      {children}
    </h4>
...
export function P({ children, className }: TypographyProps) {
  return (
    <p className={cn(
      "leading-6 [&:not(:first-child)]:mt-2",
      className
    )}>
      {children}
    </p>
