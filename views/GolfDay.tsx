    ...
    <div style={{ background: '#fdfcfb' }}>
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(to right, rgba(7,30,54,0.78) 0%, rgba(7,30,54,0.56) 30%, rgba(7,30,54,0.20) 60%, rgba(7,30,54,0) 84%)' }}
        />
        <div className={`${WRAP} absolute inset-0 flex items-center`}>
          ...
          <p
            className="text-white font-black leading-[1.1] tracking-tight max-w-[14ch]"
            /* The backdrop is a photo, so the gradient alone can't guarantee contrast
               against local highlights — the scrim covers the bright specks. */
            style={{ fontSize: 'clamp(1.4rem, 3.2vw, 2.5rem)', textShadow: '0 1px 16px rgba(7,30,54,0.9)' }}
          >
