...
/* ─── Figma assets ─── */
const IMG_HERO         = 'https://www.figma.com/api/mcp/asset/5bdcefe3-372f-45c0-8c26-e7036cdd33d9'
const IMG_STORY_L      = 'https://www.figma.com/api/mcp/asset/83cbaf7f-5f77-42ea-95ff-ad9c65d44fbf'
const IMG_FULL         = 'https://www.figma.com/api/mcp/asset/3bfef420-504b-4fee-a1fd-e23b0b16dc85'
const IMG_CARE_A       = 'https://www.figma.com/api/mcp/asset/da35da6d-748c-4cbd-8560-bae547458d41'
const IMG_CARE_B       = 'https://www.figma.com/api/mcp/asset/4b9c16bc-d320-4583-8274-cc313948700a'
const IMG_CARE_C       = 'https://www.figma.com/api/mcp/asset/83ebd731-d1d6-4e25-8ec1-4043fd96d895'
const IMG_SPLIT_L      = 'https://www.figma.com/api/mcp/asset/69200ab8-4697-4e3e-b879-30530c370ee2'
const IMG_SPLIT_R      = 'https://www.figma.com/api/mcp/asset/454789e7-c35d-468d-98df-1c8135e95597'
...
const IMG_DONATE_BG    = 'https://www.figma.com/api/mcp/asset/0e1218a3-5135-4759-8e29-7fb0e6f90597'
const IMG_QUOTE_BG     = 'https://www.figma.com/api/mcp/asset/53a06822-a0a7-495d-89d7-745b4c5fb128'
...
export default function About() {
  ...
  return (
    <div style={{ background: '#f4f4f4', overflowX: 'clip' }}>
      ...
      <div className={`${WRAP} pb-20 xl:pb-[100px]`}>
        <Reveal direction="up">
          <div className="relative rounded-[24px] overflow-hidden" style={{ minHeight: '523px' }}>
            <img src={IMG_DONATE_BG} alt="" className="absolute inset-0 w-full h-full object-cover" />
            <div
              className="absolute inset-0"
              style={{ background: 'linear-gradient(to right, rgba(5,5,5,0.0) 20%, rgba(5,5,5,0.45) 52%, rgba(5,5,5,0.82) 100%)' }}
            />
            <div className="relative z-10 flex items-center justify-end min-h-[523px]">
              <div className="max-w-[580px] p-10 sm:p-12 xl:p-16 flex flex-col gap-5">
                ...
                >
                  <span style={{ color: '#171717' }}>Give a Child Their </span>
                  <em style={{ color: '#ff7518', fontFamily: PLAYFAIR, fontStyle: 'italic' }}>First Smile</em>
                </h2>
                <p className="leading-[1.7]" style={{ fontSize: '18px', color: '#071e36', maxWidth: '440px' }}>
