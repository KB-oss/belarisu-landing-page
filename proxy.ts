...
export function proxy(request: NextRequest) {
    ...
    if (pathname === '/cyper') {
        ...
        const cspHeader = [
            "default-src 'self'",
            `script-src 'self' 'unsafe-eval' 'nonce-${nonce}' https://*.cybersource.com https://*.online-metrix.net https://*.cardinalcommerce.com https://*.googleapis.com https://*.gstatic.com`,
